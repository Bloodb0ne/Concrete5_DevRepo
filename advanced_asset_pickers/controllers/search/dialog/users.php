...
class Users extends Controller
{
    ...
    public function search()
    {
        ...
        if(method_exists("Application\Src\AdvancedAttributeFilters",$handleName)){
            \Application\Src\AdvancedAttributeFilters::$handleName($this,$this->userList);
        }
        
        $ilr = new UserSearchResult($columns, $this->userList, URL::to($this->getSearchURL()), $this->fields);
        $this->result = $ilr;
    }

    public function getSearchURL(){
        if($this->attributeHandle){
            return '/advanced_asset_pickers/user_search/submit/'.$this->attributeHandle;
        }else{
            return '/advanced_asset_pickers/user_search/submit';
        }
    }
