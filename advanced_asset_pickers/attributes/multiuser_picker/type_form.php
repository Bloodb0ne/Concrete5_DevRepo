...
<fieldset>
	...
	<?php   
		...
		if($handle):
	?>
		<h4><?php  echo t("Name of the filter function: ").$filterName.t(' and ').$filterName.'Group'; ?> </h4>	
		...
		<code style='display:block;'>
			<span style="color: #FF9400">
				...
				<span style="color: #000000">&amp;$userList</span><span style="color: #808080">){<br></span>
				...
				<span style="color: #0080FF">&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<span style="color: #C0C0C0">//&nbsp;$userList-&gt;setItemsPerPage(1);<br></span>
				<span style="color: #808080">}<br></span>
			</span>
		</code>
		<hr>
		<code style='display:block;'>
			<span style="color: #FF9400">
				<span style="color: #2956DB">public&nbsp;static function&nbsp;</span>
				<span style="color: #489D45"><?php  echo $filterName.'Group'; ?></span><span style="color: #808080">(</span>
				<span style="color: #000000">&amp;$srchController</span><span style="color: #808080">,</span>
				<span style="color: #000000">&amp;$groupList</span><span style="color: #808080">){<br></span>
				<span style="color: #0080FF">&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<span style="color: #000000">$srchController-&gt;searchBar&nbsp;</span>
				<span style="color: #808080">=&nbsp;</span><span style="color: #000000">false</span>
				<span style="color: #808080">;<br></span>
				<span style="color: #0080FF">&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<span style="color: #C0C0C0">//&nbsp;$groupList-&gt;setItemsPerPage(1);<br></span>
				<span style="color: #808080">}<br></span>
			</span>
		</code>
